...
На основе моих скромных знаний предлажил бы использовать Kubernetes. 
Есть поддержка контейнеров. 
Обнаружение и маршрутизация сервисов может происходить с помощью API или с помощью DNS. 
Горизонтальное масштабирование, и автоматическое тоже есть. 
